  ...
  private refreshMarkers() {
    ...
    if (this.isAdmin() && this.showStbAgencies) {
      ...
      this.sites.forEach(site => {
        ...
        const markerHtml = '<div style="background:' + color + ';color:white;border-radius:50% 50% 50% 0;transform:rotate(-45deg);width:32px;height:32px;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,0.4);border:2px solid white;"><span style="transform:rotate(45deg);font-size:16px;">G</span></div>';
